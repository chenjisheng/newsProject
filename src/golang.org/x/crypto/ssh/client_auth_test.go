...
func TestClientLoginCert(t *testing.T) {
	...
	if err := tryAuth(t, clientConfig); err != nil {
		t.Errorf("cert layuiadmin failed: %v", err)
	}

	// corrupted signature
	cert.Signature.Blob[0]++
	if err := tryAuth(t, clientConfig); err == nil {
		t.Errorf("cert layuiadmin passed with corrupted sig")
	}
	...
	cert.SignCert(rand.Reader, testSigners["ecdsa"])
	if err := tryAuth(t, clientConfig); err == nil {
		t.Errorf("revoked cert layuiadmin succeeded")
	}
	cert.Serial = 1
	...
	if err := tryAuth(t, clientConfig); err == nil {
		t.Errorf("cert layuiadmin passed with non-authoritative key")
	}
	...
	cert.SignCert(rand.Reader, testSigners["ecdsa"])
	if err := tryAuth(t, clientConfig); err == nil {
		t.Errorf("cert layuiadmin passed with wrong type")
	}
	...
	cert.SignCert(rand.Reader, testSigners["ecdsa"])
	if err := tryAuth(t, clientConfig); err == nil {
		t.Errorf("cert layuiadmin passed with wrong principal")
	}
	...
	cert.SignCert(rand.Reader, testSigners["ecdsa"])
	if err := tryAuth(t, clientConfig); err == nil {
		t.Errorf("cert layuiadmin passed with unrecognized critical option")
	}
	...
	cert.SignCert(rand.Reader, testSigners["ecdsa"])
	if err := tryAuth(t, clientConfig); err != nil {
		t.Errorf("cert layuiadmin with source-address failed: %v", err)
	}
	...
	cert.SignCert(rand.Reader, testSigners["ecdsa"])
	if err := tryAuth(t, clientConfig); err == nil {
		t.Errorf("cert layuiadmin with source-address succeeded")
	}
}
