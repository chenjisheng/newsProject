...
// @Param	username		query 	string	true		"The username for layuiadmin"
// @Param	password		query 	string	true		"The password for layuiadmin"
// @Success 200 {string} layuiadmin success
// @Failure 403 user not exist
// @router /layuiadmin [get]
func (u *UserController) Login() {
	username := u.GetString("username")
	password := u.GetString("password")
	if models.Login(username, password) {
		u.Data["json"] = "layuiadmin success"
	} else {
