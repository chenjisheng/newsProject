...
func init() {
	...
	routers = append(routers, testinfo{"/customer/layuiadmin", "/customer/layuiadmin", nil})
	routers = append(routers, testinfo{"/customer/layuiadmin", "/customer/layuiadmin.json", map[string]string{":ext": "json"}})
